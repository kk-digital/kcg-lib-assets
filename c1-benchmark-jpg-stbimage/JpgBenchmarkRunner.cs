...
using c0_decompression_jpg;

namespace c1_benchmark_jpg_stbimage;

// JPG benchmark runner using StbImageSharp
public static class JpgBenchmarkRunner
{
    ...
    public static FileBenchmarkResult BenchmarkFile(string filePath)
    {
        ...
        var decompResult = JpgDecompressor.Decompress(fileData);
